...
from cbfidelisbridge import version
...
setup(
    ...
    description='Carbon Black Fidelis Bridge',
    long_description=__doc__,
    packages=['cbfidelisbridge', ],
    data_files=data_files,
    package_dir = {'cbfidelisbridge': 'src/cbfidelisbridge'},
    package_data={'cbfidelisbridge': ['content/*']},
